...
- [x] ✅ Align docs/manual test/spec references with the new single policy. - Updated `README.md`, `.agents/skills/browser-bridge/SKILL.md`, `docs/manual-test.md`, and `docs/tool-coverage.md` to reflect optional-session `drive.navigate` parity and shared contract guardrails.
