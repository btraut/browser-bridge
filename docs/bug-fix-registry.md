...
- `deferred-click-settle-and-retry` - `drive.click` now waits for deferred CDP click dispatch to land and retries one transient locator miss, reducing racey menu-trigger and overlay-item failures on live pages. Ref: pending commit
