...
- `inspect-explicit-tab-targeting` - Inspect commands honor explicit `tab_id` hints end-to-end, and `drive.tab_activate` degrades focus verification failures to warnings once the requested tab is active. Ref: `30a767e`
