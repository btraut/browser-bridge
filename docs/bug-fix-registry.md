...
- `visible-css-locator-preference` - CSS/testid locator resolution now prefers visible matches before falling back to the first raw node, which avoids hidden duplicate quantity controls eating clicks in deck-builder UIs. Ref: pending commit
